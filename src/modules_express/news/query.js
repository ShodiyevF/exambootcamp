...
// update news set news_title = $2 where news_id = $1 and;
// `

// const updateNewsViewsQuery = `
// update news set news_views = news_views + 1 where news_id = $1 and;
// `
